...
export type RoutingStrategy = 'round-robin' | 'weighted-round-robin' | 'fill-first' | 'quota-drain';
...
export type VisualConfigValues = {
  ...
  routingQuotaDrainRefreshInterval: string;
  routingQuotaDrainStaleAfter: string;
