...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: ['round-robin', 'weighted-round-robin', 'wrr', 'fill-first', 'quota-drain', 'quota', 'usage limit'],
  },
  {
    fieldId: 'routingQuotaDrainRefreshInterval',
    sectionId: 'network',
    labelKey: L('sections.network.quota_drain_refresh_interval'),
    hintKey: L('sections.network.quota_drain_refresh_interval_hint'),
    yamlKeys: ['routing', 'quota-drain', 'refresh-interval'],
    keywords: ['quota-drain', 'poll', 'refresh'],
  },
  {
    fieldId: 'routingQuotaDrainStaleAfter',
    sectionId: 'network',
    labelKey: L('sections.network.quota_drain_stale_after'),
    hintKey: L('sections.network.quota_drain_stale_after_hint'),
    yamlKeys: ['routing', 'quota-drain', 'stale-after'],
    keywords: ['quota-drain', 'stale', 'fallback'],
  },
  {
