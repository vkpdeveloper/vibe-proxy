    ...
    (currentYaml: string): string => {
      try {
        ...
        const routingDirty =
          ...
          dirtyFields.has('routingQuotaDrainRefreshInterval') ||
          dirtyFields.has('routingQuotaDrainStaleAfter') ||
        ...
        if (routingDirty) {
          ...
          if (dirtyFields.has('routingQuotaDrainRefreshInterval')) {
            setStringInDoc(
              doc,
          ...
          if (dirtyFields.has('routingQuotaDrainStaleAfter')) {
            setStringInDoc(
              doc,
